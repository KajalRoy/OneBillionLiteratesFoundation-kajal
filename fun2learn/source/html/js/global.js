...
  $.get( "http://localhost/fun2learn/source/html/indexReader.php", function(data) {
})
  .done(function(data) {
	...
	var ks = data.split("\n");
           $.each(ks, function(key, value){
              ...
              Content1 += '</div></div>';
              Content1 += '<img src="http://localhost/fun2learn/resources/thumbnails/thumbnail'+(key+1)+'.png" class="img-responsive" alt="">';
              ...
              Content +='<img src="http://localhost/fun2learn/resources/thumbnails/thumbnail'+(key+1)+'.png" class="img-responsive img-centered" alt="">';
              Content +='<a href="http://localhost/fun2learn/source/html/questions.php?topicId='+value+'&questionType=MCQ">';
              Content +='<button type="button" class="btn btn-success btn-lg">Multiple Choice Questions</button>';
              Content +='</a> <tr/> <tr/><tr/> <tr/><tr/> <tr/>';
              Content +='<a href="http://localhost/fun2learn/source/html/questions.php?topicId='+value+'&questionType=matching">';
              Content +='<button type="button" class="btn btn-success btn-lg">Match The Following</button>';
              Content +='</a> <br/> <br/>';
              Content +='<a href="http://localhost/fun2learn/source/html/questions.php?topicId='+value+'&questionType=anagrams">';
              Content +='<button type="button" class="btn btn-success btn-lg">Anagrams</button>';
              Content +='</a> <tr/> <tr/> <tr/> <tr/><tr/> <tr/>';
              Content +='<a href="http://localhost/fun2learn/source/html/questions.php?topicId='+value+'&questionType=fillblanks">';
              ...
              Content2 += '</div></div>';
              Content2 += '<img src="http://localhost/fun2learn/resources/thumbnails/thumbnail'+(key+1)+'.png" class="img-responsive" alt="">';
              Content2 += '</a></div>';
              ...
              Content3 +='<img src="http://localhost/fun2learn/resources/thumbnails/thumbnail'+(key+1)+'.png" class="img-responsive img-centered" alt="">';
